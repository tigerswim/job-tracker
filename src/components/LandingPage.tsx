            ...
            <div className="hidden lg:block">
              <div className="relative">
                ...
                <div className="relative bg-white/70 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-200/60 overflow-hidden">
                  ...
                  {/* Mock navigation tabs - matches actual tab design - Network tab active */}
                    ...
                    <div className="bg-white/70 backdrop-blur-sm rounded-xl p-2 border border-slate-200/60">
                      <div className="grid grid-cols-4 gap-2">
                        <div className="p-3 rounded-lg hover:bg-white/50">
                          <div className="flex items-center gap-2">
                            ...
                            <div className="text-left">
                              <div className="text-xs font-semibold text-slate-600">Job Pipeline</div>
                        ...
                        <div className="relative p-3 rounded-lg bg-white shadow-lg border border-slate-200/80">
                          <div className="flex items-center gap-2">
                            <div className="w-8 h-8 rounded-lg bg-gradient-to-r from-slate-500 to-slate-600 flex items-center justify-center shadow-lg">
                              <Users className="w-4 h-4 text-white" />
                            </div>
                            <div className="text-left">
                              <div className="text-xs font-semibold text-slate-800">Network</div>
                              <div className="text-[10px] text-slate-500">Contacts</div>
                            </div>
                          </div>
                          <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-8 h-0.5 bg-gradient-to-r from-slate-500 to-slate-600 rounded-full" />
                        </div>
                        <div className="p-3 rounded-lg hover:bg-white/50">
                          <div className="flex items-center gap-2">
                            <div className="w-8 h-8 rounded-lg bg-slate-100 flex items-center justify-center">
                  ...
                  {/* Mock contact cards - matches actual ContactCard design with 3-column grid */}
                  <div className="px-4 pb-6">
                    ...
                    <div className="bg-white/90 backdrop-blur-sm rounded-xl p-3 border border-slate-200/60 shadow-sm hover:shadow-lg hover:scale-[1.02] transition-all cursor-pointer">
                      ...
                      <div className="flex justify-between items-start mb-2">
                        <div className="flex items-center space-x-2 flex-1 min-w-0">
                          ...
                          <div className="flex-1 min-w-0">
                            <h3 className="text-sm font-bold text-slate-800 truncate">Jordan Chen</h3>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center space-x-1 text-slate-600 mb-1">
                        ...
                        <p className="text-xs truncate">Acme Industries</p>
                      </div>

                      {/* Job Title */}
                      <div className="flex items-center space-x-1 text-slate-600 mb-1">
                        <Briefcase className="w-3 h-3 flex-shrink-0 text-slate-400" />
                        <p className="text-xs truncate">VP of Engineering</p>
                      </div>
                    ...
                    <div className="bg-white/90 backdrop-blur-sm rounded-xl p-3 border border-slate-200/60 shadow-sm hover:shadow-lg hover:scale-[1.02] transition-all cursor-pointer">
                      <div className="flex justify-between items-start mb-2">
                        <div className="flex items-center space-x-2 flex-1 min-w-0">
                          ...
                          <div className="flex-1 min-w-0">
                            <h3 className="text-sm font-bold text-slate-800 truncate">Sarah Park</h3>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center space-x-1 text-slate-600 mb-1">
                        <Building className="w-3 h-3 flex-shrink-0 text-slate-400" />
                        <p className="text-xs truncate">CloudScale</p>
                      </div>

                      <div className="flex items-center space-x-1 text-slate-600 mb-1">
                        <Briefcase className="w-3 h-3 flex-shrink-0 text-slate-400" />
                        <p className="text-xs truncate">Head of Product</p>
                      </div>

                      <div className="flex items-center space-x-1 text-xs text-slate-500 mb-2">
                        <Mail className="w-3 h-3 text-slate-400" />
                        <span className="truncate">sarah.p@email.com</span>
                      </div>
                    ...
                    <div className="bg-white/90 backdrop-blur-sm rounded-xl p-3 border border-slate-200/60 shadow-sm hover:shadow-lg hover:scale-[1.02] transition-all cursor-pointer">
                      <div className="flex justify-between items-start mb-2">
                        <div className="flex items-center space-x-2 flex-1 min-w-0">
                          ...
                          <div className="flex-1 min-w-0">
                            <h3 className="text-sm font-bold text-slate-800 truncate">Marcus Rodriguez</h3>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center space-x-1 text-slate-600 mb-1">
                        <Building className="w-3 h-3 flex-shrink-0 text-slate-400" />
                        <p className="text-xs truncate">DesignLabs</p>
                      </div>

                      <div className="flex items-center space-x-1 text-slate-600 mb-2">
                        <Briefcase className="w-3 h-3 flex-shrink-0 text-slate-400" />
                        <p className="text-xs truncate">Senior UX Designer</p>
                      </div>
                    ...
                    <div className="bg-white/90 backdrop-blur-sm rounded-xl p-3 border border-slate-200/60 shadow-sm hover:shadow-lg hover:scale-[1.02] transition-all cursor-pointer">
                      <div className="flex justify-between items-start mb-2">
                        <div className="flex items-center space-x-2 flex-1 min-w-0">
                          ...
                          <div className="flex-1 min-w-0">
                            <h3 className="text-sm font-bold text-slate-800 truncate">Alex Kim</h3>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center space-x-1 text-slate-600 mb-1">
                        <Building className="w-3 h-3 flex-shrink-0 text-slate-400" />
                        <p className="text-xs truncate">TechFlow</p>
                      </div>

                      <div className="flex items-center space-x-1 text-slate-600 mb-2">
                        <Briefcase className="w-3 h-3 flex-shrink-0 text-slate-400" />
                        <p className="text-xs truncate">Engineering Manager</p>
                      </div>
                    ...
                    <div className="bg-white/90 backdrop-blur-sm rounded-xl p-3 border border-slate-200/60 shadow-sm hover:shadow-lg hover:scale-[1.02] transition-all cursor-pointer">
                      <div className="flex justify-between items-start mb-2">
                        <div className="flex items-center space-x-2 flex-1 min-w-0">
                          ...
                          <div className="flex-1 min-w-0">
                            <h3 className="text-sm font-bold text-slate-800 truncate">Priya Patel</h3>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center space-x-1 text-slate-600 mb-1">
                        <Building className="w-3 h-3 flex-shrink-0 text-slate-400" />
                        <p className="text-xs truncate">DataCorp</p>
                      </div>

                      <div className="flex items-center space-x-1 text-slate-600 mb-1">
                        <Briefcase className="w-3 h-3 flex-shrink-0 text-slate-400" />
                        <p className="text-xs truncate">Data Scientist</p>
                      </div>
                    ...
                    <div className="bg-white/90 backdrop-blur-sm rounded-xl p-3 border border-slate-200/60 shadow-sm hover:shadow-lg hover:scale-[1.02] transition-all cursor-pointer">
                      <div className="flex justify-between items-start mb-2">
                        <div className="flex items-center space-x-2 flex-1 min-w-0">
                          ...
                          <div className="flex-1 min-w-0">
                            <h3 className="text-sm font-bold text-slate-800 truncate">Michael Torres</h3>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center space-x-1 text-slate-600 mb-1">
                        <Building className="w-3 h-3 flex-shrink-0 text-slate-400" />
                        <p className="text-xs truncate">BuildRight</p>
                      </div>

                      <div className="flex items-center space-x-1 text-slate-600 mb-2">
                        <Briefcase className="w-3 h-3 flex-shrink-0 text-slate-400" />
                        <p className="text-xs truncate">Product Lead</p>
                      </div>
                  ...
                  {!isEmailMode ? (
                    <>
                      ...
                      <button
                        ...
                        disabled={loading}
                        className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-white border-2 border-slate-300 rounded-xl hover:bg-slate-50 hover:border-slate-400 hover:scale-105 transition-all duration-200 shadow-md hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                    ...
                    <>
                      ...
                      <form onSubmit={handleEmailAuth} className="space-y-4">
                        ...
                        <button
                          type="submit"
                          disabled={loading}
                          className="w-full px-6 py-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold rounded-xl hover:shadow-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
